# Copilot Instructions for entra-access-graph-engine
A Rust CLI that maps every Entra ID object to a privilege graph, detecting escalation paths, hidden admin chains, and risk scores, and exporting the result as JSON, GraphML, or an interactive HTML report.
## Code style
